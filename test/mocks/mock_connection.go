...
func (m *MockConnection) Delete(arg0 string, arg1 connection.RequestBody) (*connection.APIResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockConnection) Patch(arg0 string, arg1 connection.RequestBody) (*connection.APIResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockConnection) Post(arg0 string, arg1 connection.RequestBody) (*connection.APIResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockConnection) Put(arg0 string, arg1 connection.RequestBody) (*connection.APIResponse, error) {
	m.ctrl.T.Helper()
