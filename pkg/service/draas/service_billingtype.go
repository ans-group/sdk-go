...
func (s *Service) getBillingTypesPaginatedResponseBody(parameters connection.APIRequestParameters) (*GetBillingTypesResponseBody, error) {
	body := &GetBillingTypesResponseBody{}
