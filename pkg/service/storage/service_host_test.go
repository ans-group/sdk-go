...
func TestGetHosts(t *testing.T) {
	t.Run("Single", func(t *testing.T) {
		...
		c.EXPECT().Get("/ukfast-storage/v1/hosts", gomock.Any()).Return(&connection.APIResponse{
	...
	t.Run("ConnectionError_ReturnsError", func(t *testing.T) {
		...
		c.EXPECT().Get("/ukfast-storage/v1/hosts", gomock.Any()).Return(&connection.APIResponse{}, errors.New("test error 1"))
...
func TestGetHost(t *testing.T) {
	t.Run("Valid", func(t *testing.T) {
		...
		c.EXPECT().Get("/ukfast-storage/v1/hosts/123", gomock.Any()).Return(&connection.APIResponse{
			Response: &http.Response{
	...
	t.Run("ConnectionError_ReturnsError", func(t *testing.T) {
		...
		c.EXPECT().Get("/ukfast-storage/v1/hosts/123", gomock.Any()).Return(&connection.APIResponse{}, errors.New("test error 1")).Times(1)
