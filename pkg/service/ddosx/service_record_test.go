...
func TestGetRecordsPaginated(t *testing.T) {
	t.Run("Valid", func(t *testing.T) {
		...
		records, err := s.GetRecordsPaginated(connection.APIRequestParameters{})
	...
	t.Run("ConnectionError_ReturnsError", func(t *testing.T) {
		...
		c.EXPECT().Get("/ddosx/v1/records", gomock.Any()).Return(&connection.APIResponse{}, errors.New("test error 1")).Times(1)

		_, err := s.GetRecordsPaginated(connection.APIRequestParameters{})
