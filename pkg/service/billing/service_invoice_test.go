...
func TestGetInvoices(t *testing.T) {
	t.Run("Single", func(t *testing.T) {
		...
		c.EXPECT().Get("/billing/v1/invoices", gomock.Any()).Return(&connection.APIResponse{
	...
	t.Run("ConnectionError_ReturnsError", func(t *testing.T) {
		...
		c.EXPECT().Get("/billing/v1/invoices", gomock.Any()).Return(&connection.APIResponse{}, errors.New("test error 1"))
...
func TestGetInvoice(t *testing.T) {
	t.Run("Valid", func(t *testing.T) {
		...
		c.EXPECT().Get("/billing/v1/invoices/123", gomock.Any()).Return(&connection.APIResponse{
			Response: &http.Response{
	...
	t.Run("ConnectionError_ReturnsError", func(t *testing.T) {
		...
		c.EXPECT().Get("/billing/v1/invoices/123", gomock.Any()).Return(&connection.APIResponse{}, errors.New("test error 1")).Times(1)
...
func TestGetInvoiceQueries(t *testing.T) {
	...
	t.Run("ConnectionError_ReturnsError", func(t *testing.T) {
		...
		c.EXPECT().Get("/billing/v1/invoice-queries", gomock.Any()).Return(&connection.APIResponse{}, errors.New("test error 1"))
...
func TestGetInvoiceQuery(t *testing.T) {
	...
	t.Run("ConnectionError_ReturnsError", func(t *testing.T) {
		...
		c.EXPECT().Get("/billing/v1/invoice-queries/123", gomock.Any()).Return(&connection.APIResponse{}, errors.New("test error 1")).Times(1)
