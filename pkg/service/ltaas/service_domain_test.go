...
func TestGetDomain(t *testing.T) {
	t.Run("Valid", func(t *testing.T) {
		...
		c.EXPECT().Get("/ltaas/v1/domains/123", gomock.Any()).Return(&connection.APIResponse{
			Response: &http.Response{
	...
	t.Run("ConnectionError_ReturnsError", func(t *testing.T) {
		...
		c.EXPECT().Get("/ltaas/v1/domains/123", gomock.Any()).Return(&connection.APIResponse{}, errors.New("test error 1")).Times(1)
...
func TestGetDomainContent(t *testing.T) {
	t.Run("Valid", func(t *testing.T) {
		mockCtrl := gomock.NewController(t)
		defer mockCtrl.Finish()
		...
		c.EXPECT().Get("/ltaas/v1/domains/123/download", gomock.Any()).Return(&connection.APIResponse{
			Response: &http.Response{
		...
		content, err := s.GetDomainContent(123)
	...
	t.Run("ConnectionError_ReturnsError", func(t *testing.T) {
		...
		c.EXPECT().Get("/ltaas/v1/domains/123/download", gomock.Any()).Return(&connection.APIResponse{}, errors.New("test error 1")).Times(1)

		_, err := s.GetDomainContent(123)
...
func TestGetDomainPrivateKey(t *testing.T) {
	t.Run("Valid", func(t *testing.T) {
		mockCtrl := gomock.NewController(t)
		defer mockCtrl.Finish()
		...
		c.EXPECT().Get("/ltaas/v1/domains/123/private-key", gomock.Any()).Return(&connection.APIResponse{
			Response: &http.Response{
		...
		key, err := s.GetDomainPrivateKey(123)
	...
	t.Run("ConnectionError_ReturnsError", func(t *testing.T) {
		...
		c.EXPECT().Get("/ltaas/v1/domains/123/private-key", gomock.Any()).Return(&connection.APIResponse{}, errors.New("test error 1")).Times(1)

		_, err := s.GetDomainPrivateKey(123)
