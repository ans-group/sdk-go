	...
	t.Run("Single", func(t *testing.T) {
		...
		c.EXPECT().Get("/ecloud/v2/firewall-policies", gomock.Any()).Return(&connection.APIResponse{
			Response: &http.Response{
				Body:       io.NopCloser(bytes.NewReader([]byte("{\"data\":[{\"id\":\"fwp-abcdef12\"}],\"meta\":{\"pagination\":{\"total_pages\":1}}}"))),
				StatusCode: 200,
			},
		}, nil).Times(1)
...
func TestGetFirewallPolicy(t *testing.T) {
	t.Run("Valid", func(t *testing.T) {
		...
		c.EXPECT().Get("/ecloud/v2/firewall-policies/fwp-abcdef12", gomock.Any()).Return(&connection.APIResponse{
			Response: &http.Response{
				Body:       io.NopCloser(bytes.NewReader([]byte("{\"data\":{\"id\":\"fwp-abcdef12\"}}"))),
				StatusCode: 200,
			},
		}, nil).Times(1)
...
func TestCreateFirewallPolicy(t *testing.T) {
	t.Run("Valid", func(t *testing.T) {
		...
		c.EXPECT().Post("/ecloud/v2/firewall-policies", &req).Return(&connection.APIResponse{
			Response: &http.Response{
				Body:       io.NopCloser(bytes.NewReader([]byte("{\"data\":{\"id\":\"fwp-abcdef12\",\"task_id\":\"task-abcdef12\"}}"))),
				StatusCode: 200,
			},
		}, nil).Times(1)

		taskRef, err := s.CreateFirewallPolicy(req)

		assert.Nil(t, err)
		assert.Equal(t, "fwp-abcdef12", taskRef.ResourceID)
...
func TestPatchFirewallPolicy(t *testing.T) {
	t.Run("Valid", func(t *testing.T) {
		...
		task, err := s.PatchFirewallPolicy("fwp-abcdef12", req)

		assert.Nil(t, err)
		assert.Equal(t, "fwp-abcdef12", task.ResourceID)
	...
	t.Run("ConnectionError_ReturnsError", func(t *testing.T) {
		...
		_, err := s.PatchFirewallPolicy("fwp-abcdef12", PatchFirewallPolicyRequest{})
	...
	t.Run("InvalidFirewallPolicyID_ReturnsError", func(t *testing.T) {
		...
		_, err := s.PatchFirewallPolicy("", PatchFirewallPolicyRequest{})
...
func TestDeleteFirewallPolicy(t *testing.T) {
	t.Run("Valid", func(t *testing.T) {
		...
		taskID, err := s.DeleteFirewallPolicy("fwp-abcdef12")
	...
	t.Run("ConnectionError_ReturnsError", func(t *testing.T) {
		...
		_, err := s.DeleteFirewallPolicy("fwp-abcdef12")
