...
func TestGetFirewallsPaginated(t *testing.T) {
	t.Run("Valid", func(t *testing.T) {
		...
		firewalls, err := s.GetFirewallsPaginated(connection.APIRequestParameters{})
	...
	t.Run("ConnectionError_ReturnsError", func(t *testing.T) {
		...
		c.EXPECT().Get("/ecloud/v1/firewalls", gomock.Any()).Return(&connection.APIResponse{}, errors.New("test error 1")).Times(1)

		_, err := s.GetFirewallsPaginated(connection.APIRequestParameters{})
